...
function renderPrograms() {
  ...
  <p class="text-sm text-gray-600 mt-1 flex-grow">${program.desc}</p>
  ...
  <a href="./programform.html"
     class="mt-4 w-full text-center bg-[#770325] text-white py-2 rounded-lg hover:bg-gray-900 transition block">
